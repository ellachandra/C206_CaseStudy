...
public class TuitionManagement {
	...
	public static void main(String[] args) {
		...
		// Administrator admin = new Administrator("admin123","p4ssword", "John Doe",
		...
		Course c2 = new Course("CS102", "Java Corp 2", "Advanced journey of Java", "NA level", 40,
...
//									}
							...
							while (optionD != ADMIN_STUDENT_QUIT) {
								...
								if (optionD == ADMIN_STUDENT_ADD) {
									...
									String educationHistory = Helper
											.readString("Enter Student's Highest level of Certification: ");

									// Create a new Student object with user input
									Student newStudent = new Student(studentID, studentPassword, studentName,
											studentNumber, studentEmail, educationHistory);
								...
								if (choice == ADMIN_ATTENDANCE_ADD) {
									...
									if (student != null) {
										...
										for (int i = 1; i <= numOfLessons; i++) {
											String lessonNo = Helper
													.readString("Enter lesson number for Lesson " + i + ": ");
											boolean isPresent = Helper.readBoolean(
													"Is the student present for Lesson " + i + "? (true/false): ");
									...
									if (student != null) {
										...
										System.out.println("Attendance for student " + studentId + " in course "
												+ courseCode + " has been deleted.");
	...
	public static void addEnrolment(ArrayList<Course> courseList, ArrayList<Student> students,
		...
		boolean added = doAddEnrolment(courseList, students, enrolmentList, e);
	...
	public static boolean doAddEnrolment(ArrayList<Course> courseList, ArrayList<Student> students, ArrayList<Enrolment> enrolmentList, Enrolment e) {
